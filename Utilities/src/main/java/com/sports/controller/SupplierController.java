...
import com.sports.dao.SupplierDAO;
import com.sports.model.Product;
import com.sports.model.Supplier;
...
public class SupplierController {
	 ...
	 @RequestMapping(value="/AddSupplier",method=RequestMethod.POST)
	 	public ModelAndView AddSupplier(@ModelAttribute Supplier srdt, HttpServletRequest request,RedirectAttributes attributes,Model m)
	 		...
	 		ModelAndView mv=new ModelAndView("Admin","Supplier",new Supplier());
	 		return mv;
	 ...
	 @RequestMapping(value="/EditSupplier",method=RequestMethod.GET)
		public ModelAndView editsupplier(@RequestParam("sid")int sid,Model m) 
		{
			...
			ModelAndView mv=new ModelAndView("EditSupplier","EditSupplier",new Supplier());
			return mv;
		...
		public ModelAndView deletesupplier(@RequestParam("id")int sid,Model m)
		
		{
			sdao.DeleteSupplier(sid);
			m.addAttribute("list",getdata());
			ModelAndView mv=new ModelAndView("ViewSupplier","ViewSupplier",new Supplier());
			return mv;
		}	 
